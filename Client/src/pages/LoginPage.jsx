...
export default function LoginPage(){
    ...
    return (
        <div className="mt-10 border border-gray-300 rounded-4xl p-6 shadow-md shadow-gray-400 size-96 mx-auto">
            <h1 className="text-center font-medium mb-4">Log in or sign up</h1>
            <form className="imax-w-md mx-auto flex flex-col gap-4" onSubmit={handleLoginSubmit}>
